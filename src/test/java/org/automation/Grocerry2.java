...
public class Grocerry2 extends BaseClass {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement goToCart = driver.findElement(By.xpath("//i[@class='fa fa-shopping-cart']"));
		goToCart.click();
		
		WebElement cart = driver.findElement(By.xpath("//a[@class='hover1']"));
		executor.executeScript("arguments[0].click();", cart);
				
		Thread.sleep(2000);
		
		List<WebElement> elements = driver.findElements(By.xpath("(//div[@class='container'])[3]//img[contains(@src,'https://omrbranch.com/front/ima')]"));
		...
		WebElement goToCart1 = driver.findElement(By.className("hover1"));
		goToCart1.click();

		Thread.sleep(1000);

		WebElement addAddress = driver.findElement(By.xpath("//div[@class='diffAddres addAddress d-flex justify-content-center align-items-center mb-md-0 mb-2']"));
		addAddress.click();
